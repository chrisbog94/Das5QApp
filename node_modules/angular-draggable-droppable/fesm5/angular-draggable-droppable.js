...
var DraggableHelper = /** @class */ (function () {
    ...
    /** @nocollapse */ DraggableHelper.ngInjectableDef = defineInjectable({
...
var DraggableDirective = /** @class */ (function () {
    ...
    function () {
        ...
        /** @type {?} */
        var pointerDragged$ = this.pointerDown$.pipe(filter(function () {
            return _this.canDrag();
        }), mergeMap(function (pointerDownEvent) {
            ...
            }).pipe(startWith(startScrollPosition), map(function () {
            ...
            dragEnded$
                .pipe(mergeMap(function (dragEndData) {
                    /** @type {?} */
                    var dragEndData$ = cancelDrag$.pipe(count(), take(1), map(function (calledCount) {
        ...
        merge(pointerDragged$.pipe(take(1), map(function (value) {
            return [, value];
...
var DroppableDirective = /** @class */ (function () {
    ...
    function () {
        ...
        this.currentDragSubscription = this.draggableHelper.currentDrag.subscribe(function (drag$) {
            ...
            overlapsChanged$
                .pipe(filter(function (overlapsNow) {
                    return overlapsNow;
                }))
                .subscribe(function () {
                    dragOverActive = true;
...
export {
    DragAndDropModule,
    DraggableHelper as ɵc,
    DraggableScrollContainerDirective as ɵd,
    DraggableDirective as ɵb,
    DroppableDirective as ɵa
};
