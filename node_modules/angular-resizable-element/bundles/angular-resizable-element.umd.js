(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function getResizeEdges(_a) {
        var clientX = _a.clientX, clientY = _a.clientY, elm = _a.elm, allowedEdges = _a.allowedEdges,
            cursorPrecision = _a.cursorPrecision;
        /** @type {?} */
    ...
    var ResizableDirective = /** @class */ (function () {
        ...
        function () {
            ...
            mouseMove.pipe(operators.filter(function () {
            ...
            this.resizeEdges$
                .pipe(operators.startWith(this.resizeEdges), operators.map(function () {
                    return (_this.resizeEdges &&
                        Object.keys(_this.resizeEdges).some(function (edge) {
            ...
            var mousedrag = this.mousedown
                .pipe(operators.mergeMap(function (startCoords) {
                    ...
                    return rxjs.merge(mouseMove.pipe(operators.take(1)).pipe(operators.map(function (coords) {
                        return [, coords];
                    })), mouseMove.pipe(operators.pairwise()))
    ...
    var ResizeHandleDirective = /** @class */ (function () {
        ...
        ResizeHandleDirective.propDecorators = {
            resizeEdges: [{type: core.Input}],
            onMousedown: [{
                type: core.HostListener, args: ['touchstart', [
                    '$event',
            ...
            onMouseup: [{
                type: core.HostListener, args: ['touchend', [
