...
test('is.arguments', function (t) {
    ...
    (function () {
        t.ok(is.arguments(arguments), 'arguments is arguments');
    }());
    (function () {
        t.notOk(is.arguments(Array.prototype.slice.call(arguments)), 'sliced arguments is not arguments');
    }());
    t.end();
});
...
test('is.arguments.empty', function (t) {
    ...
    (function () {
        t.ok(is.arguments.empty(arguments), 'empty arguments is empty arguments');
    }());
    (function () {
        t.notOk(is.arguments.empty(Array.prototype.slice.call(arguments)), 'empty sliced arguments is not empty arguments');
    }());
    t.end();
});
...
test('is.error', function (t) {
    ...
    }), 'object with error\'s toString is not error');
    t.end();
});
