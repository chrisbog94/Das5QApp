...
function handle(request, options) {
    var followRedirects = options.followRedirects, type = options.type, unzip = options.unzip,
        rejectUnauthorized = options.rejectUnauthorized, ca = options.ca, key = options.key, cert = options.cert,
        agent = options.agent;
            ...
            .then(function () {
                return new Promise(function (resolve, reject) {
                    ...
                    function response(incomingMessage) {
                        var headers = incomingMessage.headers, rawHeaders = incomingMessage.rawHeaders,
                            status = incomingMessage.statusCode, statusText = incomingMessage.statusMessage;
                    ...
                    rawRequest.on('response', function (message) {
                        resolve(storeCookies(url, message.headers).then(function () {
