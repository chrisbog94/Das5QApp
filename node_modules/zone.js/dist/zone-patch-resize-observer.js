...
(function (global, factory) {
    ...
    Zone.__load_patch('ResizeObserver', function (global, Zone, api) {
        ...
        api.patchMethod(global, 'ResizeObserver', function (delegate) {
        ...
        api.patchMethod(ResizeObserver.prototype, 'observe', function (delegate) {
            return function (self, args) {
        ...
        api.patchMethod(ResizeObserver.prototype, 'unobserve', function (delegate) {
            return function (self, args) {
                var target = args.length > 0 ? args[0] : null;
                if (!target) {
                    return delegate.apply(self, args);
        ...
        api.patchMethod(ResizeObserver.prototype, 'disconnect', function (delegate) {
            return function (self, args) {
                var targets = self[resizeObserverSymbol];
                if (targets) {
